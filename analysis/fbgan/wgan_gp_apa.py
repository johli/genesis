...
class WGAN_LangGP():
    def __init__(self, batch_size=64, lr=0.0001, num_epochs=150, seq_len = 205, data_dir='./data/apa_simple_seqs_strong.txt', \
        run_name='apa_simple_strong', hidden=512, d_steps = 10):
        self.hidden = hidden
...
def main():
    ...
    parser.add_argument("--run_name", default= "apa_simple_strong", help="Name for output files (checkpoint and sample dir)")
