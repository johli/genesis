...
class WGAN_LangGP():
    def __init__(self, batch_size=64, lr=0.0001, num_epochs=150, seq_len = 145, data_dir='./data/mpradragonn_seqs_sample.txt', \
        run_name='fbgan_mpradragonn_sample', hidden=512, d_steps = 10, max_examples=2000):
        
        self.sequence_template = 'N' * 145
        
        self.preds_cutoff = 1.2#1.8#2.4
        self.hidden = hidden
...
def main():
    ...
    parser.add_argument("--run_name", default= "fbgan_mpradragonn_sample", help="Name for output files")
