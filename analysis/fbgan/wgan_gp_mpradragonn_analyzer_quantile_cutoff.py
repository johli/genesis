...
class WGAN_LangGP():
    def __init__(self, batch_size=64, lr=0.0001, num_epochs=150, seq_len = 145, data_dir='./data/mpradragonn_seqs_sample.txt', \
        run_name='fbgan_mpradragonn_sample_quantile_cutoff_60', hidden=512, d_steps = 10, max_examples=2000):
        
        self.sequence_template = 'N' * 145
        
        self.preds_cutoff = None#0.2#1.2#1.8#2.4
        self.quantile = 60
    ...
    def build_model(self):
        ...
        self.analyzer = DragoNNClassifier() #from PYTORCH
    ...
    def load_model(self, directory = '', iteration=None):
        ...
        if iteration is None:
            ...
            G_file = directory + "G_weights_{}.pth".format(iteration)
            D_file = directory + "D_weights_{}.pth".format(iteration)
...
def main():
    ...
    parser.add_argument("--run_name", default= "fbgan_mpradragonn_sample_quantile_cutoff_60", help="Name for output files")
    parser.add_argument("--load_dir", default="./checkpoint/mpradragonn_sample/", help="Load pretrained GAN checkpoints")
