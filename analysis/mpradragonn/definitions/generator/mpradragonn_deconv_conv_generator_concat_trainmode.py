...
def get_shallow_copy_function(master_generator, copy_number=1) :
	...
	def copy_generator_network(batch_size, sequence_class, n_classes=1, seq_length=145, supply_inputs=False, master_generator=master_generator, copy_number=copy_number) :
...
def load_generator_network(batch_size, sequence_class, n_classes=1, seq_length=100, supply_inputs=False) :
	...
	#Policy network definition
	policy_dense_1 = Dense(14 * 384, activation='relu', kernel_initializer='glorot_uniform', name='policy_dense_1')
	...
	policy_deconv_1 = Conv2DTranspose(192, (6, 1), strides=(2, 1), padding='valid', activation='linear', kernel_initializer='glorot_normal', name='policy_deconv_1')
