...
def load_generator_network(batch_size, sequence_class, n_classes=1, seq_length=205, supply_inputs=False) :
	...
	#Policy network definition
	policy_dense_1 = Dense(9 * 384, activation='relu', kernel_initializer='glorot_uniform', name='policy_dense_1')
	...
	relu_deconv_0_out_1 = concat_cond_0([relu_0(batch_norm_0(policy_deconv_0(dense_1_out_1))), class_embedding])
	relu_deconv_1_out_1 = concat_cond_1([relu_1(batch_norm_1(policy_deconv_1(relu_deconv_0_out_1))), class_embedding])
	relu_deconv_2_out_1 = concat_cond_2([relu_2(batch_norm_2(policy_deconv_2(relu_deconv_1_out_1))), class_embedding])
	relu_deconv_3_out_1 = concat_cond_3([relu_3(batch_norm_3(policy_conv_3(relu_deconv_2_out_1))), class_embedding])
	relu_deconv_4_out_1 = concat_cond_4([relu_4(batch_norm_4(policy_conv_4(relu_deconv_3_out_1))), class_embedding])
	
	policy_out_1 = Reshape((seq_length, 4, 1))(policy_conv_5(relu_deconv_4_out_1))

	dense_1_out_2 = concat_cond_dense_1([policy_dense_1_reshape(policy_dense_1(seed_input_2)), class_embedding])
	
	relu_deconv_0_out_2 = concat_cond_0([relu_0(batch_norm_0(policy_deconv_0(dense_1_out_2))), class_embedding])
	relu_deconv_1_out_2 = concat_cond_1([relu_1(batch_norm_1(policy_deconv_1(relu_deconv_0_out_2))), class_embedding])
	relu_deconv_2_out_2 = concat_cond_2([relu_2(batch_norm_2(policy_deconv_2(relu_deconv_1_out_2))), class_embedding])
	relu_deconv_3_out_2 = concat_cond_3([relu_3(batch_norm_3(policy_conv_3(relu_deconv_2_out_2))), class_embedding])
	relu_deconv_4_out_2 = concat_cond_4([relu_4(batch_norm_4(policy_conv_4(relu_deconv_3_out_2))), class_embedding])
