...
def get_shallow_copy_function(master_generator, copy_number=1) :
	...
	def copy_generator_network(batch_size, sequence_class, n_classes=1, seq_length=1000, supply_inputs=False, master_generator=master_generator, copy_number=copy_number) :
		...
		policy_dense_1_reshape = Reshape((125, 1, 128))
...
def load_generator_network(batch_size, sequence_class, n_classes=1, seq_length=1000, supply_inputs=False) :
	...
	#Policy network definition
	policy_dense_1 = Dense(125 * 128, activation='relu', kernel_initializer='glorot_uniform', name='policy_dense_1')
	
	policy_dense_1_reshape = Reshape((125, 1, 128))
	
	policy_deconv_0 = Conv2DTranspose(256, (7, 1), strides=(2, 1), padding='same', activation='linear', kernel_initializer='glorot_normal', name='policy_deconv_0')
	
	policy_deconv_1 = Conv2DTranspose(192, (7, 1), strides=(2, 1), padding='same', activation='linear', kernel_initializer='glorot_normal', name='policy_deconv_1')
	
	policy_deconv_2 = Conv2DTranspose(128, (7, 1), strides=(2, 1), padding='same', activation='linear', kernel_initializer='glorot_normal', name='policy_deconv_2')
