...
def get_load_generator_network_func(gan_func) :
	...
	def load_generator_network(batch_size, sequence_class, n_classes=1, seq_length=205, supply_inputs=False, gan_func=gan_func) :
		...
		seed_out_1 = policy_dense_2(relu_1(batch_norm_1(policy_dense_1(relu_0(batch_norm_0(policy_dense_0(seed_input_1)))))))
		seed_out_2 = policy_dense_2(relu_1(batch_norm_1(policy_dense_1(relu_0(batch_norm_0(policy_dense_0(seed_input_2)))))))
